import rules from '../fixtures/regras-axe.json';
...
function callback(violations) {
	...
	violations.forEach((violation) => {
		...
		if (rule[0] !== null) {
			...
			if (rule[0].category === 'best-practice') countBestPracticeFail = countBestPracticeFail + 1;
		} else {
...
Cypress.Commands.add('componentAccessibility', (selector) => {
    ...
    */
	cy.injectAxe();
	cy.checkA11y(selector, {}, callback, false);
});
